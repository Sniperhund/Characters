import type { Character, Relationship, Reside } from "./types"

export const characterTemplate = (char: Character) => `
...
export const characterInfoTemplate = (character: Character) => `
<div class="name">
...
export const relationshipTemplate = (person: Relationship) => `
...
export const resideTemplate = (place: Reside) => `
<div
    style="
        background-image: linear-gradient(
                180deg,
...
export const swiperTemplate = (character: Character) => {
    let imageString
